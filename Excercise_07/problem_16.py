...
print(is_valid_email("ex@ample@domain.com")) # False
print(is_valid_email("example@domain.c")) # False
print(is_valid_email("example.domain.com")) # False
print(is_valid_email("example@domaincom")) # False
print(is_valid_email("1example@domain.com")) # True
print(is_valid_email(".example@domain.com")) # False
print(is_valid_email("example@domain..com")) # False